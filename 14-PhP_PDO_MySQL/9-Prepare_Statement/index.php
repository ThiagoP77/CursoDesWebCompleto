...
if(!empty($_POST['usuario']) && !empty($_POST['senha'])) {
    ...
    try {
        ...
        $stmt->bindValue(':usuario', $_POST['usuario']);//Remove a Injection 
        $stmt->bindValue(':senha', $_POST['senha']);//Remove a Injection 
        //Obs.: Pode ter 3 parametro, definindo o tipo de dado que pode ser usado dessa informação inserida
